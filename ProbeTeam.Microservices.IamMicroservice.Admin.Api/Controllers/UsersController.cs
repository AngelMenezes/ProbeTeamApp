...
using ProbeTeam.Microservices.IamMicroservice.Admin.Api.Dtos.Roles;
using ProbeTeam.Microservices.IamMicroservice.Admin.Api.Dtos.Users;
...
using ProbeTeam.Microservices.IamMicroservice.Admin.Api.Resources;
using Skoruba.IdentityServer4.Admin.BusinessLogic.Identity.Dtos.Identity;
using Skoruba.IdentityServer4.Admin.BusinessLogic.Identity.Services.Interfaces;

namespace ProbeTeam.Microservices.IamMicroservice.Admin.Api.Controllers
{
        ...
        where TRoleClaimsDto : RoleClaimsDto<TRoleDtoKey>
    {
        ...
        /// <summary>
        /// Cria um usuário com o Role de Coach
        /// Customer Role Id = 3f649695-00d3-42ed-b1dc-82e9194b162f
        /// </summary>
        ...
        public async Task<ActionResult<TUserDto>> PostCustomer([FromBody] UserPasswordDto userPasswordDto)
        {
            ...
            var role = await _identityService.GetRoleAsync("3f649695-00d3-42ed-b1dc-82e9194b162f");
