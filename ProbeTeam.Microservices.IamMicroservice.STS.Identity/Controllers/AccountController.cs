...
using ProbeTeam.Microservices.IamMicroservice.STS.Identity.ViewModels.Account;

namespace ProbeTeam.Microservices.IamMicroservice.STS.Identity.Controllers
{
    [SecurityHeaders]
    [Authorize]
