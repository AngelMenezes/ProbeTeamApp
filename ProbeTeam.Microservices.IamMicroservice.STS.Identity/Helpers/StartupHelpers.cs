...
using SendGrid;
using ProbeTeam.Microservices.IamMicroservice.STS.Identity.Configuration;
using ProbeTeam.Microservices.IamMicroservice.STS.Identity.Configuration.ApplicationParts;
using ProbeTeam.Microservices.IamMicroservice.STS.Identity.Configuration.Constants;
using ProbeTeam.Microservices.IamMicroservice.STS.Identity.Configuration.Interfaces;
using ProbeTeam.Microservices.IamMicroservice.STS.Identity.Helpers.Localization;
using ProbeTeam.Microservices.IamMicroservice.STS.Identity.Services;
using System.Linq;
using Skoruba.IdentityServer4.Admin.EntityFramework.Interfaces;
using ProbeTeam.Microservices.IamMicroservice.Admin.EntityFramework.MySql.Extensions;
using ProbeTeam.Microservices.IamMicroservice.Admin.EntityFramework.PostgreSQL.Extensions;
using ProbeTeam.Microservices.IamMicroservice.Admin.EntityFramework.Shared.Configuration;
using ProbeTeam.Microservices.IamMicroservice.Admin.EntityFramework.SqlServer.Extensions;
using Skoruba.IdentityServer4.Admin.EntityFramework.Helpers;

namespace ProbeTeam.Microservices.IamMicroservice.STS.Identity.Helpers
{
